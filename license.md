# Minecraft License Suite – MLS-2
## § 1 – Rights of Use
1. Use of this mod is permitted exclusively for private use.
1. Source Inspection: You are allowed to view and inspect the source code for educational purposes or to report issues.
1. Prohibition of Modification: Any form of modification, alteration, or "remixing" of the source code or assets (textures, models, sounds) is strictly prohibited.
1. Integration into modpacks is only permitted if these are hosted on authorized platforms (CurseForge, Modrinth) and do not pursue any commercial intentions.
## § 2 – Commercial Use
1. Any commercial use, including the sale of the mod, parts of the mod, or the generation of advertising revenue through unauthorized downloads, is prohibited.
